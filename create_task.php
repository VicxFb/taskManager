    ...
    <div class="container">
        <div class="box form-box">
            ...
            if (isset($_POST['submit'])) {
                ...
                $user_id = $_SESSION['id'];
                $task_status_id = 1;
                $query = "INSERT INTO tareas (nombre_tarea, descripcion_tarea, fecharegistro_tarea, fechavencimiento_tarea, observacion_tarea, id_usuario_tarea, id_tipotarea_tarea, id_estadotarea_tarea) VALUES ('$task_name', '$task_description', current_timestamp(), '$task_due_date', '', '$user_id', 1, 1)";
