...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-05-2024 a las 02:22:57
...
INSERT INTO `estadotareas` (`id_estadotarea`, `nombre_estadotarea`) VALUES
(1, 'Programada'),
(2, 'En ejecución'),
(3, 'Finalizada');
...
CREATE TABLE `municipios` (
  ...
  `id_departamento_municipio` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `municipios` (`id_municipio`, `nombre_municipio`, `id_departamento_municipio`) VALUES
('05001', 'MEDELLÍN', '05'),
('05002', 'ABEJORRAL', '05'),
('05004', 'ABRIAQUÍ', '05'),
('05021', 'ALEJANDRÍA', '05'),
...
INSERT INTO `tipotareas` (`id_tipotarea`, `nombre_tipotarea`) VALUES
(1, 'Personal'),
(2, 'Laboral'),
(3, 'Familiar'),
(4, 'Otro');
...
CREATE TABLE `usuarios` (
  ...
  `id_municipio_usuario` varchar(7) NOT NULL,
...
INSERT INTO `usuarios` (`id_usuario`, `login_usuario`, `nombre_usuario`, `email_usuario`, `celular_usuario`, `password_usuario`, `foto_usuario`, `id_municipio_usuario`, `edad_usuario`) VALUES
('70', 'Juanma', 'Juan Mata', 'nosoyjuanmata@gmail.com', '3012002334', 'Clave70', '190003', '19001', 25),
('76', 'Gabohosorio', 'Gabriel Osorio', 'gaboh.osorio@hotmail.com', '3002002121', 'Clave76', '190002', '19001', 30),
('77', 'Marypaz', 'María Paz', 'mari.p@unicom.edu.co', '3002099080', 'Clave77', '190001', '19001', 0),
('78', 'SoyElPedro', 'Pedro Perez', 'perezpedro@gmail.com', '3012002320', 'Clave78', '190002', '19548', 0),
('79', 'Carmenga', 'Carmen Galindo', 'carmengea@unicom.edu.co', '3012002329', 'Clave79', '190001', '05154', 0),
('81', 'MarioR', 'Mario Rodriguez', 'soymario.r@unicom.edu.co', '3012002321', 'Clave81', '190002', '19807', 0),
('82', 'JuliaInCu', 'Julia Ines Cuevas', 'juliacuevas@unicom.edu.co', '3012002345', 'Clave82', '190002', '19548', 0),
('83', 'SandraP', 'Sandra Patricia Pino', 'sandrapinopardo@hotmail.com', '3012002348', 'Clave83', '190002', '19807', 0),
('84', 'ArmandoSi', 'Armando Sinisterra', 'armansinistbel@gmail.com', '3012002312', 'Clave84', '190001', '05059', 0),
('85', 'Johnmar', 'John Elias Martinez', 'jonh345mart@gmail.com', '3112049012', 'Clave85', '190003', '05154', 0),
('91', 'Gregoryp', 'Gregorio Paz', 'gregory.p@hotmail.com', '3112049015', 'Clave91', '190002', '19807', 0);
...
ALTER TABLE `municipios`
  ...
  ADD KEY `id_departamento_municipio` (`id_departamento_municipio`);
...
ALTER TABLE `usuarios`
  ...
  ADD KEY `id_municipio_usuario` (`id_municipio_usuario`);
...
--
ALTER TABLE `estadotareas`
  MODIFY `id_estadotarea` tinyint(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `tipotareas`
  MODIFY `id_tipotarea` tinyint(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `municipios`
  ADD CONSTRAINT `fk_departamento_municipio` FOREIGN KEY (`id_departamento_municipio`) REFERENCES `departamentos` (`id_departamento`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `fk_municipios_usuarios` FOREIGN KEY (`id_municipio_usuario`) REFERENCES `municipios` (`id_municipio`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
